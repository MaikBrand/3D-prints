...
result_A = result.union(cq.Workplane('front').text("54LV10-DK",6,0.4 , kind="bold").translate([pad_x/2,0, pad_thick]))

show_object(result_A)

# Export first design as file formats used by 3D printers
cq.exporters.export(result_A, "./step/54LV10-DK_clip.step")
cq.exporters.export(result_A, "./stl/54LV10-DK_clip.stl")
...
# Add text for identification of supported DK's
result_Murata = result_Murata.union(cq.Workplane('front').text("54LV10-Murata",6,0.4 , kind="bold").translate([pad_x/2,0, pad_thick]))
...
cq.exporters.export(result_Murata, "./step/54LV10-DK_Murata_coax_clip.step")
cq.exporters.export(result_Murata, "./stl/54LV10-DK_Murata_coax_clip.stl")
...
# Add text for identification of supported DK's
result_MS156 = result_MS156.union(cq.Workplane('front').text("54LV10-MS156",6,0.4 , kind="bold").translate([pad_x/2,0, pad_thick]))
...
cq.exporters.export(result_MS156, "./step/54LV10-DK-MS156_coax_clip.step")
cq.exporters.export(result_MS156, "./stl/54LV10-DK-MS156_coax_clip.stl")
