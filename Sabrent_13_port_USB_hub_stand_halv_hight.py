...
cq.exporters.export(results, "./step/Sabrent_13_port_USB_hub_stand_halv_hight.step")
cq.exporters.export(results, "./stl/Sabrent_13_port_USB_hub_stand_halv_hight.stl")
