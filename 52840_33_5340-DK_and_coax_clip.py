...
# for Nordic's 52840/52833/5340 DK's 
# 
...
groves = grove.union(grove.mirror((1, 0, 0), (pad_x/2, 0, 0)))
...
result_A = result.union(cq.Workplane('front').text("52840/33-5340-DK",4.5,0.1).translate([pad_x/2,18, pad_thick]))

show_object(result_A)

# Export first design as file formats used by 3D printers
cq.exporters.export(result_A, "./step/52840_33_5340-DK_clip.step")
cq.exporters.export(result_A, "./stl/52840_33_5340-DK_clip.stl")
...
# Add text for identification of supported DK's
result_Murata = result_Murata.union(cq.Workplane('front').text("52840/33-5340-Murata",4,0.4 , kind="bold").translate([pad_x/2,18, pad_thick]))
...
cq.exporters.export(result_Murata, "./step/52840_33_5340-Murata_coax_clip.step")
cq.exporters.export(result_Murata, "./stl/52840_33_5340-Murata_coax_clip.stl")
...
# Add text for identification of supported DK's
result_MS156 = result_MS156.union(cq.Workplane('front').text("52840/33-5340-MS156",4,0.4 , kind="bold").translate([pad_x/2,18, pad_thick]))
...
cq.exporters.export(result_MS156, "./step/52840_33_5340-MS156_coax_clip.step")
cq.exporters.export(result_MS156, "./stl/52840_33_5340-MS156_coax_clip.stl")
